...
(( now possible: key:value (replace), key\_!REMOVE! : value (remove), key\_!UPDATE! : (add or replace), use: language:en
...
1. :ref:`Find out <t3sphinx-installation>` where your current *t3sphinx* resides
