...
Git Repository with TYPO3 specific stuff
========================================
...
.. tip:: Good to know:
   ...
   This is the main tool by which we distribute TYPO3 specific
   additions to the Sphinx documentation tools.


RestTools.git/composer.json
---------------------------
...
---------------------------------------
Status: Important, active, to be carried on.
...
--------------------------
Status: Historic, not deployed any more.
...
A LaTeX style and an image file to add the TYPO3 logo to LaTeX output.
...
RestTools.git/Meta
------------------
Status: Historic, frozen archive.
...
-----------------------------------------
Status: Historic, frozen, archived.
...
RestTools.git/T3PythonDocBuilderPackage
---------------------------------------

Status: Important, active, to be continued.

This Python package represents and contains all the knowledge about the conversion
process from OpenOffice documents to ReST and Sphinx formats.
...
RestTools.git/ToolsForTheCourageous/forge-typo3-org-issue-42376
---------------------------------------------------------------
...
Status: Probably more historic. Is now contained as a subpart in :ref:`t3pdb`.
